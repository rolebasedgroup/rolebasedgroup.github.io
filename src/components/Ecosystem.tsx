    ...
    <section
      ...
      <div className="container">
        ...
        <div className={`ecosystem-grid ${isVisible ? 'animate-in' : ''}`}>
          ...
          <div className="ecosystem-card card-animate glow-on-hover" style={{ transitionDelay: '300ms' }}>
            <div className="ecosystem-card__icon">
          ...
          <div className="ecosystem-card card-animate glow-on-hover" style={{ transitionDelay: '350ms' }}>
            <div className="ecosystem-card__icon">
        ...
        <div className="ecosystem-links">
          <a href="https://github.com/sgl-project/rbg" className="ecosystem-link ripple-effect">
          ...
          <a href="https://sgl-fru7574.slack.com/archives/C098X0LQZV5" className="ecosystem-link ripple-effect">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <a href="https://github.com/sgl-project/sglang" className="ecosystem-link ripple-effect">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
