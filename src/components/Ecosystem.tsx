    ...
    <section
      ...
      <div className="container">
        ...
        <div className={`ecosystem-grid ${isVisible ? 'animate-in' : ''}`}>
          <div className="ecosystem-card card-animate" style={{ transitionDelay: '250ms' }}>
          ...
          <div className="ecosystem-card card-animate" style={{ transitionDelay: '300ms' }}>
            <div className="ecosystem-card__icon">
          ...
          <div className="ecosystem-card card-animate" style={{ transitionDelay: '350ms' }}>
            <div className="ecosystem-card__icon">
